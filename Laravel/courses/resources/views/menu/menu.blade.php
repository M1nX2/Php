...
<nav>
     ...
     <div class="row">
        ...
        <ul id="menu-header" class="nav-bar horizontal">
          ...
          <li><a href="{{route('rubric',[$rubric_name='Английский'])}}">Английский</a></li>
          <li><a href="{{route('rubric',[$rubric_name='Французский'])}}">Французский</a></li>
          <li><a href="{{route('rubric',[$rubric_name='Немецкий'])}}">Немецкий</a></li>
          <li><a href="{{route('rubric',[$rubric_name='Китайский'])}}">Китайский</a></li>  
          <li><form id="logout-form" action="{{ route('logout') }}" method="POST" >
    @csrf
    <input type="submit" value="Выйти"> 
</form></li>    
        <li style="padding:0px 30px;"><a href="{{route('prof')}}">{{$name}}</a></li>
        </ul>
